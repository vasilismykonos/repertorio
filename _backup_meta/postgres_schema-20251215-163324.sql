...
\restrict n5dRxQDsfVde74l0JuRqKwL0do7SAngC7qxEJebjKPiayJZCnTwA8PX15g06eBg
...
--
-- Name: ListItem_listId_idx; Type: INDEX; Schema: app; Owner: rep_user
--

CREATE INDEX "ListItem_listId_idx" ON app."ListItem" USING btree ("listId");


--
-- Name: ListItem_songId_idx; Type: INDEX; Schema: app; Owner: rep_user
--

CREATE INDEX "ListItem_songId_idx" ON app."ListItem" USING btree ("songId");


--
-- Name: List_groupId_idx; Type: INDEX; Schema: app; Owner: rep_user
--

CREATE INDEX "List_groupId_idx" ON app."List" USING btree ("groupId");
...
--
-- Name: SongCredit_artistId_idx; Type: INDEX; Schema: app; Owner: rep_user
--

CREATE INDEX "SongCredit_artistId_idx" ON app."SongCredit" USING btree ("artistId");
...
--
-- Name: SongCredit_songId_idx; Type: INDEX; Schema: app; Owner: rep_user
--

CREATE INDEX "SongCredit_songId_idx" ON app."SongCredit" USING btree ("songId");


--
-- Name: SongVersionArtist_artistId_idx; Type: INDEX; Schema: app; Owner: rep_user
--

CREATE INDEX "SongVersionArtist_artistId_idx" ON app."SongVersionArtist" USING btree ("artistId");
...
--
-- Name: SongVersionArtist_versionId_idx; Type: INDEX; Schema: app; Owner: rep_user
--

CREATE INDEX "SongVersionArtist_versionId_idx" ON app."SongVersionArtist" USING btree ("versionId");


--
-- Name: SongVersion_createdByUserId_idx; Type: INDEX; Schema: app; Owner: rep_user
--

CREATE INDEX "SongVersion_createdByUserId_idx" ON app."SongVersion" USING btree ("createdByUserId");
...
--
-- Name: SongVersion_songId_idx; Type: INDEX; Schema: app; Owner: rep_user
--

CREATE INDEX "SongVersion_songId_idx" ON app."SongVersion" USING btree ("songId");
...
\unrestrict n5dRxQDsfVde74l0JuRqKwL0do7SAngC7qxEJebjKPiayJZCnTwA8PX15g06eBg
