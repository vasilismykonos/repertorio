    ...
    <>
      <aside id="sidebar" className={sidebarClass} aria-hidden={!isOpen}>
        ...
        <style jsx global>{`
          ...
          .smh-notifications-read:disabled {
            opacity: 0.5;
            cursor: not-allowed;
          }
          ...
          a.smh-notification:hover {
            background: rgba(255, 255, 255, 0.1);
          }

          .smh-notification-title {
            display: flex;
            align-items: center;
            gap: 7px;
            min-width: 0;
          ...
          .smh-notification-title span:last-child {
            min-width: 0;
            overflow: hidden;
            text-overflow: ellipsis;
            white-space: nowrap;
          ...
          .smh-notification-body,
          .smh-notification-time {
            min-width: 0;
            overflow: hidden;
            text-overflow: ellipsis;
            white-space: nowrap;
