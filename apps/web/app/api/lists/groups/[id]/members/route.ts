// apps/web/app/api/lists/groups/[id]/members/route.ts
...
export async function GET(req: NextRequest, ctx: { params: { id: string } }) {
  const groupId = parseId(ctx.params);
  if (!groupId) {
  ...
  const url = `${getApiBase()}/lists/groups/${groupId}/members?userId=${encodeURIComponent(String(me.id))}`;
