// apps/web/app/api/lists/groups/[id]/members/[memberUserId]/route.ts
...
export async function DELETE(
  ...
  const groupId = parsePosInt(ctx.params.id);
  ...
  const url = `${getApiBase()}/lists/groups/${groupId}/members/${memberUserId}?userId=${encodeURIComponent(String(me.id))}`;
